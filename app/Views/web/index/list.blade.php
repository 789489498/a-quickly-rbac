...
var hanlder = function(that){
  var requestUrl = "<?= url("menu/postquery") ?>";
...
////Add
var hanlder = function(that){
  var requestUrl = "<?= url("menu/postadd") ?>";
  var params = getParams();
...
var hanlder = function(that){
  ...
  var requestUrl = "<?= url("menu/postrow") ?>";
  var tableColumns = $("#tableColumns").val();
...
var hanlder = function(that){
  var requestUrl = "<?= url("menu/postupdate") ?>";
  var tableColumns = $("#tableColumns").val();
  var params = getParams();
  $.ajax({
    "url": requestUrl,
...
////Remove Confirm
var hanlder = function(that) {
  var requestUrl = "<?= url("menu/postdelete") ?>";
  var tableColumns = $("#tableColumns").val();
  var params = getParams();
  $.ajax({
    "url": requestUrl,
