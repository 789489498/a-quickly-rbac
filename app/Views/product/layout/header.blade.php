...
<html lang="en" class="app">
  ...
  <head>
    ...
    <link rel="stylesheet" href="/template/amazing/js/bs_pagination/jquery.bs_pagination.min.css" type="text/css" />
    <link rel="stylesheet" href="/template/amazing/js/toastr/build/toastr.min.css" type="text/css" />
    <link rel="stylesheet" href="/template/amazing/css/csshake/dist/csshake.min.css" type="text/css" />
    <script src="/template/amazing/js/jquery.min.js"></script>
    <script src="/template/amazing/js/js-cookie/src/js.cookie.js"></script>
    <script src="/template/amazing/js/toastr/build/toastr.min.js"></script>
    <script src="/template/amazing/js/myApplication.js"></script>
    <!--[if lt IE 9]>
